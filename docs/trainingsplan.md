...
- **Power zuerst** (Galpin): Sprünge und Swings kommen frisch am Anfang der Einheit, nie ans Ende.
- **Deload** alle 6 Wochen: eine Woche mit halbem Volumen bei gleichem Gewicht. Danach geht es spürbar weiter statt zu stagnieren.
- **Zone-2-Budget**: Di 45 + Sa 45 Minuten Rucking plus täglich 10.000 Schritte ergeben die 150 bis 180 Minuten, die Attia und Huberman empfehlen. Wenn du an einem Samstag Zeit hast, geh 60 statt 45.
...
|---|---|---|---|---|
| Langhantel-Kniebeuge im Rack | 4 × 8–12 | 50 kg | LH | 120 s |
| Rumänisches Kreuzheben, Langhantel | 4 × 8–12 | 60 kg | LH | 90 s |
| Bulgarian Split Squat, Bench | 3 × 8–12 je Seite | 2 × 10 kg | KH | 75 s |
| Hip Thrust, Rücken an Bench, KH auf Hüfte | 3 × 10–15 | 20 kg | KH | 75 s |
...
| Übung | Sätze × Range | Start | Gerät | Pause |
|---|---|---|---|---|
| Box Jumps auf die Bench oder Sprungkniebeugen | 3 × 5 explosiv | Eigengewicht | BW | 90 s |
| Langhantel-Kniebeuge schwer im Rack | 4 × 5–8 | 60 kg | LH | 150 s |
| Langhantel-Bankdrücken flach im Rack | 4 × 5–8 | 50 kg | LH | 150 s |
| Klimmzüge mit Weste | 4 × 3–6 | Weste 5 kg | BW | 150 s |
| Woche A: Kreuzheben von den Sicherheitsablagen | 4 × 5–8 | 60 kg | LH | 150 s |
| Woche B: KH-Swings + Farmer's Carry | 4 × 12–15 + 3 × 40 m | 20 kg / 2 × 20 kg | KH | 90 s |
...
25 Minuten Flow: Katze-Kuh, Weltbester Stretch, 90/90-Hüfte, Couch Stretch, Brustwirbelsäulen-Rotation, Schulter-CARs, Deep Squat Hold mit leerer Stange, Dead Hang. 15 Minuten lockerer Spaziergang ohne Weste.

## Volumen-Check pro Woche

| Muskelgruppe | Harte Sätze | Ziel 10–16 |
|---|---|---|
| Quadrizeps | Mo 7 + Fr 4 = 11 | ✓ |
| Hintere Kette | Mo 7 + Fr 4 + Swings = 11–15 | ✓ |
| Brust | Mi 7 + Fr 4 = 11 | ✓ |
| Rücken vertikal | Mi 7 + Fr 4 = 11 | ✓ |
| Rücken horizontal | Mi 6 + Sa 0 = 6, plus Kreuzheben | ausreichend, wächst mit Rudern |
| Schultern | Mi 6 + Sa 3 = 9, plus Drücken | ✓ |
| Arme | direkt 10, indirekt viel | ✓ |
| Core | Mo 3 + Carries + Pallof 4 | ✓ |
...
1. In Zentrum: Training, „Plan“, „Vorlage laden“. Entwurf 3.1 kommt mit allen Übungen, Ranges, Startgewichten und dem passenden Gerät je Übung.
2. Erste Woche testen, Startgewichte anpassen. Danach steigert die App.
3. Nach vier Wochen Bilanz und Feinschliff.
