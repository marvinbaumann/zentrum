...
Falls in deiner iOS-Version der Typ „Trainings“ nicht in der Liste steht, sondern nur **„Trainingsminuten“**: Dann nimm die. **Health-Messungen suchen** → Typ **Trainingsminuten**, Filter „Startdatum ist heute“, danach **Statistik berechnen → Summe**. Textzeile: `exercise,heute,` + Summe. Die App zeigt die Minuten unter „Erholung“ und trägt ab 30 Minuten automatisch ein Training „Ausdauer“ ein, falls an dem Tag noch nichts steht. Ein eigener Eintrag oder ein Plan-Training hat immer Vorrang.
